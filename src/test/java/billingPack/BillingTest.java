...
public class BillingTest {
    ...
    public void expectedSimpleBill_gold_2line() {
        ...
        Assert.assertEquals(64.45-49.95, billing.getExtraFeeAsAdditionalLine(), 2);
    }

    @Test
    public void expectedSimpleBill_gold_1line() {
        billing = new Billing(new Line("seungwon", GOLD, 1, 1000));
        Assert.assertEquals(0, billing.getExtraFeeAsAdditionalLine(), 2);
    }
    ...
    public void expectedSimpleBill_silver_3line() {
        ...
        Assert.assertEquals(72.95-29.95, billing.getExtraFeeAsAdditionalLine(), 2);
    }
    ...
    public void calculateExcessMinutes_gold_999m() {
        ...
        Assert.assertEquals(0, billing.getExtraFeeAsExcessMinute(), 2);
    }
    ...
    public void calculateExcessMinutes_gold_1001m() {
        ...
        Assert.assertEquals(50.40-49.95, billing.getExtraFeeAsExcessMinute(), 2);
    }

    @Test
    public void calculateExcessMinutes_gold_1010m() {
        billing = new Billing(new Line("seungwon", GOLD, 1, 1010));
        Assert.assertEquals(54.45-49.95, billing.getExtraFeeAsExcessMinute(), 2);
    }
    ...
    public void calculateExcessMinutes_silver_520m() {
        ...
        Assert.assertEquals(40.75-29.95, billing.getExtraFeeAsExcessMinute(), 2);
    }
    ...
    public void calculateFamilyDiscount_silver_5line() {
        ...
        Assert.assertEquals(10, billing.getExtraFeeAsFamilyDiscount(), 2);
    }
